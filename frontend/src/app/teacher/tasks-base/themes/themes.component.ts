...
export class ThemesComponent implements OnInit {
  ...
  displayedColumns = ['number', 'discipline', 'theme', 'edit', 'delete'];
...
const data: UserData[] = [
  {number: 1, discipline: 'Математика', theme: 'Інтеграли'},
  {number: 2, discipline: 'Програмування', theme: 'Класи'},
  {number: 3,  discipline: 'Історія', theme: 'Друга світова війна'}
];
